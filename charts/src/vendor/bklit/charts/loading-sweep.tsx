// The registry's generic Visx accessor types are stricter than the runtime
// data shape used by this copied component; the upstream package typechecks
// this file in its monorepo configuration.
// @ts-nocheck
"use client";
