...
export function Area({
  ...
  // Keep missing checks as true gaps. Visx's area/line generators support the
  // `defined` predicate and start a fresh sub-path around null samples. The
  // registry component otherwise maps a missing value to the baseline, which
  // would visually invent an outage/latency value and bridge missing checks.
