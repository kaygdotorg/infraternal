...
export interface ChartTooltipProps {
  ...
  /** Place vertical-chart panels below the hovered point when space allows. */
  ...
  const tooltipContent = (
    <>
      ...
      <TooltipBox
        ...
        top={isHorizontal || placement === "below" ? undefined : margin.top}
        visible={visible}
        x={xWithMargin}
        y={isHorizontal || placement === "below" ? yWithMargin : margin.top}
      >
        {content && tooltipData
          ? content({
